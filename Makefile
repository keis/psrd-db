...
core_rulebook/spells.json: core_rulebook bin/import-spells $(wildcard ${DATA}/core_rulebook/spell/*.json)
core_rulebook/spells.json: ${DATA}/core_rulebook/spell/
	bin/import-spells $<

advanced_players_guide/spells.json: advanced_players_guide bin/import-spells $(wildcard ${DATA}/advanced_players_guide/spell/*.json)
advanced_players_guide/spells.json: ${DATA}/advanced_players_guide/spell/
	bin/import-spells $<

ultimate_magic/spells.json: ultimate_magic bin/import-spells $(wildcard ${DATA}/ultimate_magic/spell/*.json)
